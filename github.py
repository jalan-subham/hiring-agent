...
def _fetch_github_api(api_url, params=None):
    ...
    if DEVELOPMENT_MODE and status_code == 200:
        try:
            ...
            Path(cache_filename).write_text(json.dumps(data, indent=2, ensure_ascii=False))
    ...
    try:
        ...
        if status_code == 200:            
            ...
            for repo in repos_data:
                ...
                user_contributions, total_contributions = fetch_contributions_count(username, contributors_data)
